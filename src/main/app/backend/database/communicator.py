...
class Communicator:
    ...
    def __init__(self) -> None:
        ...
        self.driver = drivers.init_driver(uri=os.environ.get("NEO4J_URI"), username=os.environ.get("NEO4J_USERNAME"), password=os.environ.get("NEO4J_PASSWORD"))
        ...
        self.gds = GraphDataScience(uri=os.environ.get("NEO4J_URI"), username=os.environ.get("NEO4J_USERNAME"), password=os.environ.get("NEO4J_PASSWORD"), aura_ds=False)
